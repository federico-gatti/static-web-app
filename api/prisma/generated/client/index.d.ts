...
export namespace Prisma {
  ...
  */
  ...
  type GetEvaluationGroupByPayload<T extends EvaluationGroupByArgs> = PrismaPromise<
    Array<
  ...
  export type EvaluationGetPayload<S extends boolean | null | undefined | EvaluationArgs> =
    S extends { select: any, include: any } ? 'Please either choose `select` or `include`' :
    S extends true ? Evaluation :
    S extends undefined ? never :
    S extends { include: any } & (EvaluationArgs | EvaluationFindManyArgs)
    ? Evaluation 
    : S extends { select: any } & (EvaluationArgs | EvaluationFindManyArgs)
      ? {
    [P in TruthyKeys<S['select']>]:
    P extends keyof Evaluation ? Evaluation[P] : never
  } 
      : Evaluation
  ...
  export interface EvaluationDelegate<GlobalRejectSettings extends Prisma.RejectOnNotFound | Prisma.RejectPerOperation | false | undefined> {
    /**
    ...
    **/
    ...
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findUnique', 'Evaluation'> extends True ? Prisma__EvaluationClient<EvaluationGetPayload<T>> : Prisma__EvaluationClient<EvaluationGetPayload<T> | null, null>
     ...
     * })
    **/
    findUniqueOrThrow<T extends EvaluationFindUniqueOrThrowArgs>(
      args?: SelectSubset<T, EvaluationFindUniqueOrThrowArgs>
    ): Prisma__EvaluationClient<EvaluationGetPayload<T>>
    ...
    **/
    ...
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findFirst', 'Evaluation'> extends True ? Prisma__EvaluationClient<EvaluationGetPayload<T>> : Prisma__EvaluationClient<EvaluationGetPayload<T> | null, null>
     ...
     * })
    **/
    findFirstOrThrow<T extends EvaluationFindFirstOrThrowArgs>(
      args?: SelectSubset<T, EvaluationFindFirstOrThrowArgs>
    ): Prisma__EvaluationClient<EvaluationGetPayload<T>>
    ...
    **/
    ...
    ): PrismaPromise<Array<EvaluationGetPayload<T>>>
    ...
    **/
    ...
    >(args: SubsetIntersection<T, EvaluationGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetEvaluationGroupByPayload<T> : PrismaPromise<InputErrors>
   ...
   */
  export class Prisma__EvaluationClient<T, Null = never> implements PrismaPromise<T> {
    [prisma]: true;
   ...
   */
  export type EvaluationFindUniqueArgsBase = {
    /**
   ...
   */
  export interface EvaluationFindUniqueArgs extends EvaluationFindUniqueArgsBase {
   /**
   ...
   */
  export type EvaluationFindUniqueOrThrowArgs = {
    /**
     * Select specific fields to fetch from the Evaluation
     * 
    **/
   ...
   */
  export type EvaluationFindFirstArgsBase = {
    /**
     * Select specific fields to fetch from the Evaluation
     * 
    **/
   ...
   */
  export interface EvaluationFindFirstArgs extends EvaluationFindFirstArgsBase {
   /**
    * Throw an Error if query returns no results
   ...
   */
  export type EvaluationFindFirstOrThrowArgs = {
    /**
     * Select specific fields to fetch from the Evaluation
     * 
    **/
